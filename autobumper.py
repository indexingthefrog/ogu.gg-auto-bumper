...
def autobump(link,msg):
  driver.get(link)
  time.sleep(4)
  driver.find_element(By.XPATH,"/html/body/div[7]/div[1]/div[4]/form/div/div[1]/div[1]/textarea").click()
  time.sleep(4)
  driver.find_element(By.XPATH,"/html/body/div[7]/div[1]/div[4]/form/div/div[1]/div[1]/textarea").send_keys(msg)
  time.sleep(4)
  driver.find_element(By.XPATH,"/html/body/div[7]/div[1]/div[4]/form/div/div[2]/input[1]").click()
...
driver.find_element(By.XPATH,"/html/body/div[4]/div/form[2]/table/tbody/tr[4]/td/span/input").click()
